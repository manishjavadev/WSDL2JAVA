 ...
 * generated in the com.javadev.manish.schema.order package. 
...
public class ObjectFactory {
    ...
    private final static QName _OrderInquiry_QNAME = new QName("http://www.manish.javadev.com/schema/Order", "orderInquiry");
    private final static QName _OrderInquiryResponse_QNAME = new QName("http://www.manish.javadev.com/schema/Order", "orderInquiryResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.javadev.manish.schema.order
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.manish.javadev.com/schema/Order", name = "orderInquiry")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.manish.javadev.com/schema/Order", name = "orderInquiryResponse")
